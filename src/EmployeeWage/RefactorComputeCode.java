...
public class RefactorComputeCode {
    ...
    public static void main(String[] args) {
        ...
        RefactorComputeCode employee = new RefactorComputeCode();
    ...
    public static int[] calculateSalary(RefactorComputeCode employee) {
